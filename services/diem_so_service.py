    ...
    def xoa(self, mssv: str, ma_lop: str = None) -> tuple[bool, str]:
        ...
        if ma_lop:
            self._cache = [ds for ds in self._cache
                           if not (ds.mssv == mssv.upper()
                                   and ds.ma_lop == ma_lop.upper())]
        else:
            self._cache = [ds for ds in self._cache
                           if ds.mssv != mssv.upper()]
    ...
    def bang_diem_lop(self, ma_lop: str) -> list[dict]:
        ...
        for ds in danh_sach:
            ...
            ket_qua.append({
                ...
                "KT lần 1":    ds.diem_kt1,
                "KT lần 2":    ds.diem_kt2,
                "Tiểu luận":   ds.diem_tieu_luan,
        ...
        return sorted(ket_qua, key=lambda x: (x["Tổng kết"] is None,
                                               -(x["Tổng kết"] or 0)))

    def xuat_bang_diem_excel(self, ma_lop: str, duong_dan: str = None) -> str:
